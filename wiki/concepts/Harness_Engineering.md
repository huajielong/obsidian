...
Anthropic、OpenAI、Cognition、Hamel Husain 等各自用不同词汇表达同一组设计约束。以下是跨供应商整理的 4 大类别：
...
- [[摘要-awesome-agentic-ai-zh-advanced-concepts]] — 跨供应商 Harness 原则框架 + Eval Rigor + Bitter Lesson 来源

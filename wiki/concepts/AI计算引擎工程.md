...
- [[DeepSeek四份JD全景对比]] — DeepSeek 各团队定位对比中的计算引擎参考
...
- [[预训练研究]] — 协同层：预训练算法研究的架构创新对算子/通信/编译器提出新的需求与优化方向

- [[后训练研究]] — 依赖层：后训练 RL 算法的高效执行依赖算子/通信/编译器的底层优化

- [[多模态理解研究]] — 计算支撑层：视觉编码器和 VLM 的高效推理依赖底层算子优化

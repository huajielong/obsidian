...
吴恩达（Andrew Ng）是全球最知名的 AI 教育家之一，斯坦福大学计算机科学系客座教授，Coursera 与 DeepLearning.AI 联合创始人。他的《机器学习》和《深度学习》课程是 AI 领域历史上最受欢迎的入门课程之一，被数百万学习者誉为"AI 启蒙第一课"。
...
1. **AI 教育普及** — 让数百万零基础学习者从一扇最友好的门进入了 AI 世界，被称为"AI 教育之父"
2. **AI 非技术普及** — "AI for Everyone"课程面向管理者与大众，将 AI 价值、局限与转型路径讲给非技术人群
3. **Coursera 平台** — 联合创立 Coursera，重新定义了在线教育的交付方式
4. **Google Brain 创始** — 参与创建 Google Brain，推动深度学习在工业界的大规模应用
5. **百度 AI 研究院** — 领导百度 AI 团队，推动中国 AI 技术的早期发展
6. **DeepLearning.AI 生态** — 持续跟进前沿技术，推出 LLM、RAG、AI Agents 等系列短期课程

## 关联连接

- [[Mu_Li]] — 同为 AI 教育者，李沐参与翻译和改编 Andrew Ng 的课程
- [[Andrej_Karpathy]] — 同为 AI 教育者，教学风格互补（广度 vs 深度）
- [[Hung_yi_Lee]] — 同为 AI 教育者，中文 AI 教学领域代表
- [[Supervised_Learning]] — 其课程核心概念的推广者
- [[Generative_AI]] — 课程三分法概念
